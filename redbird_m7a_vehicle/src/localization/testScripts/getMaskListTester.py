...
greenMaskVals = np.array([[55,45,60],[88,230,230]])
...
while True:
    ...
    newFrameList = Utilities.copyFrameList(imageList)
    maskList = Utilities.getMaskList(newFrameList, maskValsList, 80)
    print len(maskList)
...
##        imgCList[0] = maskC
    ...
    escC = Camera.showFrame(imgC, "ROI3")
