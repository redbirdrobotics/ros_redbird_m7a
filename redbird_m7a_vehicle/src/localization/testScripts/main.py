...
maskValsList = [greenMaskVals, redMaskVals]
...
while True:
    ...
    maskList = Utilities.getMaskList(workingFrameList, maskValsList, 80)
    print len(maskList)
    ...
    #Search Whole Frame
    #Pass mask list instead of frame list
    xyrcList, colList = Utilities.blobSearch(newmaskList, groundRobot)
    Robot.update(0, roboList, xyrcList, colList, maskValsList, blobList)
